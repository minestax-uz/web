            ...
            <div className="relative flex-1 flex flex-col max-w-xs w-full bg-dark-200">
              ...
              <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                <div className="flex-shrink-0 flex items-center px-4">
                  <img className="h-8 w-auto" src="/minecraft-logo.png" alt="Minecraft Server" />
                ...
                <nav className="mt-5 px-2 space-y-1">
                  {filteredNavigation.map((item) => (
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `${
                          isActive ? "bg-dark-100 text-primary" : "text-gray-300 hover:bg-dark-100 hover:text-primary"
                        } group flex items-center px-2 py-2 text-base font-medium rounded-md`
                      }
                    >
                      <svg className="mr-4 h-6 w-6 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
          ...
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 flex-1 px-2 space-y-1">
              {filteredNavigation.map((item) => (
                ...
                >
                  <svg className="mr-3 h-6 w-6 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={item.icon} />
                  </svg>
                  {item.name}
                </NavLink>
